...
export function loadIndexerConfig(
  ...
  return {
    ...
    movementAddress: requireEnv(env, "MOVEMENT_ADDRESS"),
    reputationAddress: requireEnv(env, "REPUTATION_ADDRESS"),
    databasePath:
      env.INDEXER_DB_PATH ?? "services/indexer/data/indexer.sqlite",
